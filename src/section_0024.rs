...
#[repr(transparent)]
pub(crate) struct eight_bits(u8);
...
use pascal_io::{FromBlob, ToBlob};
use crate::pascal::packed_file_of_text_char;
use crate::pascal::packed_file_of;

...
pub(crate) fn update_terminal(io_view: MFInteractiveIoView<'_>) {
    r#break(io_view.term_out);
}

// @d clear_terminal == break_in(term_in,true) {clear the terminal input buffer}
/// clear the terminal input buffer
pub(crate) fn clear_terminal(io_view: MFInteractiveIoView<'_>) {
    break_in(io_view.term_in, true);
}
// @d wake_up_terminal == do_nothing {cancel the user's cancellation of output}
///cancel the user's cancellation of output
pub(crate) fn wake_up_terminal(_io_view: MFInteractiveIoView<'_>) {
    do_nothing!();
}

use pascal_io::r#break;
use pascal_io::break_in;
